        ...
        <!--table-->
         ...
         <DataTable :value="store.list.data"
            ...
            <Column field="name" header="Name"
             ...
             <Column field="status.name" header="Status" :sortable="true" v-if="store.isViewLarge()">
                 <template #body="prop">
                     <template v-if="prop.data.status && prop.data.status.name">
                         <Badge v-if="prop.data.status.slug === 'approved'" severity="success"> {{ prop.data.status.name }} </Badge>
                         <Badge v-else-if="prop.data.status.slug === 'rejected'" severity="danger"> {{ prop.data.status.name }} </Badge>
                         <Badge v-else severity="warning"> {{ prop.data.status.name }} </Badge>
                     </template>
                     <template v-else>
