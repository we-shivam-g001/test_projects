            ...
            <template #icons>
                ...
                <div class="p-inputgroup">
                    ...
                    <Button label="Edit"
                            ...
                            data-testid="companies-item-to-edit"
                            icon="pi pi-save"/>
                    ...
                    <Button
                        ...
                        data-testid="companies-item-menu"
                    ...
                    <Button class="p-button-primary p-button-sm"
                            icon="pi pi-times"
                            data-testid="companies-item-to-list"
                            @click="store.toList()"/>
            ...
            <div class="mt-2" v-if="store.item">
                    ...
                    <div class="flex align-items-center justify-content-between">
                        ...
                        <div class="ml-3">
                            <Button label="Restore"
                                    class="p-button-sm"
                                    data-testid="companies-item-restore"
                ...
                <table class="p-datatable-table overflow-wrap-anywhere">
                    ...
                    <template v-for="(value, column) in store.item ">
                        ...
                        <template v-if="column === 'created_by' || column === 'updated_by'|| column === 'vh_contact_id'|| column === 'slug'|| column === 'contacts'
                        || column === 'deleted_by'">
                        </template>
