<?php namespace VaahCms\Themes\Projects\Providers;


use Illuminate\Routing\Router;
use Illuminate\Support\ServiceProvider;
use Illuminate\Database\Eloquent\Factory;
use VaahCms\Themes\Projects\Providers\RouteServiceProvider;
use VaahCms\Themes\Projects\Providers\EventServiceProvider;
...
class ProjectsServiceProvider extends ServiceProvider
{
    ...
    private function registerMiddleware($router) {
        ...
        //register middleware
        //$router->aliasMiddleware('sample.middleware', \Projects\Http\Middleware\SampleMiddleware::class);
    ...
    {
        $viewPath = resource_path('/views/vaahcms/themes/projects');
        ...
        $this->loadViewsFrom(array_merge(array_map(function ($path) {
            return $path . '/views/vaahcms/themes/projects';
    ...
    public function registerAssets()
    {
        ...
        $desPath = public_path('vaahcms/themes/projects/assets');
    ...
    {
        $langPath = resource_path('/lang/vaahcms/themes/projects');
