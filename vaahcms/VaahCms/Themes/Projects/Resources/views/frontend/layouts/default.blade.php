...
<html lang="en">
    <head>
        ...
        @if(env('THEME_PROJECTS_ENV') == 'develop')
            <link href="http://localhost:8080/projects/assets/css/build.css"
                  rel="stylesheet" media="screen">
            <link href="http://localhost:8080/projects/assets/css/style.css"
                  rel="stylesheet" media="screen">
        @else
            <link  href="{{vh_theme_assets_url("Projects", "css/build.css")}}"
                   rel="stylesheet" media="screen">
            <link  href="{{vh_theme_assets_url("Projects", "css/style.css")}}"
                rel="stylesheet" media="screen">
        @endif
        -->
...
<!--        <script src="https://unpkg.com/jquery@3.6.0/dist/jquery.js"></script>
        ...
        <script src="{{vh_theme_assets_url("Projects", "build/script.js")}}"></script>-->
